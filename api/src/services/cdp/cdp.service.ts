...
export class CDPService extends EventEmitter implements BrowserRuntime {
  ...
  public waitUntil(_task: Promise<void>): void {
    // No-op: CDPService does not use background task scheduling.
    // The Orchestrator runtime handles this via TaskScheduler.
  }
