            ...
            async () => {
              ...
              const b = await puppeteer.launch({
                ...
                args: [
                  ...
                  "--enable-crashpad",
                  "--crash-dumps-dir=/tmp/chrome-dumps",
                  "--remote-debugging-address=fly-local-6pn",
                  "--remote-debugging-port=9222",
                  "--unsafely-treat-insecure-origin-as-secure=http://localhost:3000,http://fly-local-6pn:3000",
                  "--window-size=1366,768",
                  "--timezone=America/New_York",
                  "--load-extension=/app/apps/steel-browser/api/extensions/recorder",
                  "--disable-extensions-except=/app/apps/steel-browser/api/extensions/recorder",
                ],
                executablePath: "/usr/local/bin/chrome-cpuset",
                ignoreDefaultArgs: ["--enable-automation"],
                timeout: 0,
                env: {
                  TZ: "America/New_York",
